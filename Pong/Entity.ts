...
export interface ComponentFactory<TComponent extends Component, TArg0, TArg1>
{
    new (arg0?: TArg0, arg1?: TArg1): TComponent;
}
...
export class Entity {
    ...
    sendMessage(name: string, arg0: any = null, arg1: any = null): void {
    ...
    getComponent<TComponent extends Component, TArg0, TArg1>(
        type: ComponentFactory<TComponent, TArg0, TArg1>): TComponent {
        return <TComponent> this._components.find(component => {
            return (component.constructor == type);
        });
    }

    addComponent<TComponent extends Component, TArg0, TArg1>(
        type: ComponentFactory<TComponent, TArg0, TArg1>,
        arg0: TArg0 = null, arg1: TArg1 = null): TComponent {
